...
public class FilterByNameHandlerPr : IRequestHandler<FilterByNamePr, ApplicationServiceResponse<List<Product>>>
{
    ...
    public async Task<ApplicationServiceResponse<List<Product>>>Handle(FilterByNamePr request, CancellationToken cancellationToken)
    {
        ...
        List<Product> result = await products.Select(c => new Product
        {
            Id = c.Id,
